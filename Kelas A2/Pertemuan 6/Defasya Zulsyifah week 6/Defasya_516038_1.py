...
# source code pembuktian soal nomor 1 bagian B
...
class Marksman(Hero):
    ...
    def ulti(self):
        pass  # Metode ulti harus diimplementasikan, walaupun tidak digunakan

# Membuat objek Marksman
Layla = Marksman("Layla", 100, 2500)

# Memanggil metode active_skill pada objek Marksman
enemy = Marksman("Balmond", 210, 1600)
print("=== Turn 1 ===")
Layla.active_skill(enemy)
