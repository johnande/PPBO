class Rekening:
    ...
    def Transfer(self, penerima, jumlah):
        if self.saldo >= jumlah:
            ...
            print("Transfer sebesar", jumlah, "dari rekening", self.no_rekening, "ke rekening", penerima.no_rekening, "berhasil.")
            print("Saldo pengirim saat ini:", self.saldo)
        else:
            print("Saldo tidak mencukupi untuk transfer sebesar", jumlah)
...
print("\nTransaksi Transfer:")
nasabah1.Transfer(nasabah2, 500000)  # Transfer 500.000 dari Nasabah 1 ke Nasabah 2
