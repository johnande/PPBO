class Sim_Cache:
    ...
    def create_chace(self):
        ...
        self.cache_dile_name = "cache_" + self.nama_web + ".txt"
        ...
        line1 = False
        for l in sf:
            if "Start_cache" in 1: #menentukan baris awal cache
                line1 = True 
            if line1 == True: 
                cf.write(1) #menyalin cache dari source
