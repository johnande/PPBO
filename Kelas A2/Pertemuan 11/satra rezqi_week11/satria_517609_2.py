...
class View2(object):
    ...
    def list_pricing(self, services):
        for svc in services:
            print("Untuk setiap", Model.services[svc]['number'],svc, "anda harus membayar $",Model.services[svc]['price'])
...
#Instansiasi objek
number = input("what language do you want to choose? [1]English [2]Indonesia: ")
