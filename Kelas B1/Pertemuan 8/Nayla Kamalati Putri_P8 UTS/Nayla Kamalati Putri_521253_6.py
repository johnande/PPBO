...
class Rekening(Nasabah):
    ...
    def transfer(self, penerima, jumlah):
        if jumlah <= self.saldo:
            ...
            print("Transfer sebesar Rp. {:,} dari rekening {} ke rekening {} berhasil".format(jumlah, self.no_rekening, penerima.no_rekening))
...
def main():
    ...
    print("\nTransfer Rp. 500.000 dari Nasabah 1 ke Nasabah 2")
